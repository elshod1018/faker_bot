...
import static com.company.faker.FakeDataApplicationService.BLACK_LIST;

public class FakeDataApplicationRunner {
    ...
    public static void main(String[] args) {
        var builder = FakeDataGenerateRequest.builder();
        ...
        var response = FakeDataApplicationService.processRequest(builder.build());
